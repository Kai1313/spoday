<!-- Topnav -->
<nav class="navbar navbar-top navbar-expand navbar-light bg-white sticky-top shadow border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav align-items-center ml-md-auto">
                <li class="nav-item d-xl-none">
                    <!-- Sidenav toggler -->
                    <div class="pr-3 sidenav-toggler sidenav-toggler-light active" data-action="sidenav-pin"
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml--2">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <h4 class="mb-0 text-sm">Super Admin</h4>
                                            </div>
